            ...
            <div className="greenbox md:mx-6 mx-4 w-[100%] h-screen  rounded-lg bg-[#80FFDB]">
                <div className="flex flex-col lg:px-12 px-4 lg:pt-12 md:pt-8 pt-4 lg:gap-5 gap-2 ">
                    <div className="flex flex-row">
                        <p className="lg:text-3xl md:text-2xl text-xl text-[#256D85] font-bold tracking-tide uppercase lg:block md:block hidden" style={{ fontFamily: 'Poppins, sans-serif' }}>Write/   </p>
                        <p className="lg:text-3xl md:text-2xl text-xl text-[#256D85] font-bold tracking-tide uppercase lg:block md:block" style={{fontFamily: 'Poppins, sans-serif'}}>Paste down your comment here</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        {comment && prediction !== '' && (
                            <div>
                                { prediction === 1 ? (
                                    <p className="lg:text-2xl md:text-xl  text-rose-600 font-black tracking-normal lg:block md:block" style={{ fontFamily: 'Poppins, sans-serif' }}>Spam comment detected</p>
                                ) : (
                                        <p className="lg:text-2xl md:text-xl text-indigo-700 font-black tracking-normal lg:block md:block" style={{ fontFamily: 'Poppins, sans-serif' }}>It's not a spam comment</p>
                                    )}
                            </div>
                        )}
