          ...
          <div className="mx-[8%] lg:mx-16 mt-4 ">
            <div className=" flex flex-row justify-between  items-center mx-auto gap-6 ">
              ...
              <div className=" gap-6 ml-auto flex flex-row items-center ">
                <a
                  href="#"
                  className={`${FontStyles.underline_animation} ${FontStyles.navtext} hidden lg:block hover-underline-animation lg:text-xl text-base leading-6 text-[#00AA95] hover:text-green-500 transition duration-300 relative`}
                >
                  Home
                </a>
                <a
                ...
                <a
                  href="#"
                  className={`${FontStyles.underline_animation} ${FontStyles.navtext} hidden lg:block hover-underline-animation lg:text-xl text-base leading-6 text-[#00AA95] font-Bebas hover:text-green-500 transition duration-300 relative`}
                >
                  Contact Us
                </a>
              </div>
      ...
      <div className="footerbar relative ">
        <div className="bg-[#122D42] ">
          <div className="flex flex-row items-center justify-between lg:mx-16 md:mx-16  mx-5">
            <div className="">
              <Image className=" w-[109px] my-2" src={Logo} alt="logo" width={50} />
            </div>
